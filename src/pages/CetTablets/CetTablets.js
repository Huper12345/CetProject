...
export const CetTablets = () => {
    return (
        <div className="CetTablets">
            ...
            subtext1="-Назальных и глазных симптомов круглогодичного и сезонного аллергического ринита и аллергического конъюнктивита, зуда, чиханья, заложенности носа, ринореи, слезоточения, гиперемии конъюнктивы"
